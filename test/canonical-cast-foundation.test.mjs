...
test("participant reconciliation rejects omitted, undeclared, absent, inactive, and label-mismatched identities", () => {
  ...
  assert.throws(() => reconcile(inactive), /inactive at Chapter 1/u);
});
