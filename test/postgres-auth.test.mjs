...
test("real PostgreSQL migrations, sessions, and two-user state are isolated", { skip: !process.env.TEST_DATABASE_URL }, async () => {
  ...
  try {
    ...
    assert.deepEqual(concurrent.flat(), ["001_public_alpha_users.sql", "002_user_package_indexes.sql", "003_state_constraints.sql", "004_review_card_lifecycle.sql", "005_mastered_review_status.sql"]);
