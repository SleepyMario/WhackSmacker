...
try:
 for card in cards:
  b=read_until(m,b'Press 1');choices=re.findall(rb'([1-4])\. ([^\r\n]+)\r?\n',b)
...
assert all(e['packageId']=='com.sleepymario.language.japanese.japan-prefectures-easy' for e in store['events'])
