...
const coreReviewTargets: readonly {
  ...
  {
    slug: "japanese", name: "Japanese", readingId: "com.sleepymario.language.japanese", languages: ["ja", "en"], packageVersion: "0.1.0", artifactRevision: 5,
    interactionProfile: { ...defaultDeckInteractionProfile, labels: "independent" }
  },
  { slug: "korean", name: "Korean", readingId: "com.sleepymario.language.korean", languages: ["ko", "en"], packageVersion: "0.1.0", artifactRevision: 7 },
...
const chineseScriptConversionTargets: readonly ContentPackageGeneratorTarget[] = [{
  ...
  displayName: "Traditional Chinese Radicals",
  description: "The 214 Kangxi radicals with English meanings, Hanyu Pinyin, and stroke counts.",
  contentType: "topic-review",
  capabilities: ["topic-review"],
  deckFamily: "general",
  ...
  interactionProfile: { ...defaultDeckInteractionProfile, labels: "independent" },
  packageVersion: "1.0.0",
  sourcePath: "review-content/chinese-traditional/radicals",
  sourceRepository: "https://github.com/SleepyMario/whacksmacker",
  languages: ["en", "zh-Latn-pinyin", "zh-Hant"],
  targetLanguage: "zh-Hant",
  subjects: ["abc", "chinese", "kangxi", "radicals", "traditional"],
  topic: {
  ...
  displayName: "Simplified Chinese Radicals",
  description: "The 201 principal indexing components from GF 0011-2009, with English meanings, Hanyu Pinyin, attached forms, and stroke counts.",
  contentType: "topic-review",
  capabilities: ["topic-review"],
  deckFamily: "general",
  relatedPackageIds: ["com.sleepymario.language.chinese-simplified"],
  contentSchemaVersion: "2.0.0",
  deckVersion: "1.0.0",
  artifactRevision: 2,
  mediaPolicy: "none",
  interactionProfile: { ...defaultDeckInteractionProfile, labels: "independent" },
  packageVersion: "1.0.0",
  sourcePath: "review-content/chinese-simplified/radicals",
  sourceRepository: "https://github.com/SleepyMario/whacksmacker",
  languages: ["en", "zh-Latn-pinyin", "zh-Hans"],
  targetLanguage: "zh-Hans",
  subjects: ["abc", "chinese", "gf-0011-2009", "radicals", "simplified"],
  topic: {
    id: "simplified-chinese-radicals",
    displayName: "Radicals",
    deckDisplayName: "Radicals"
  },
  dependencies: [],
  ...
  topicDeck: {
    id: "simplified-chinese-radicals",
    displayName: "Radicals",
    outputFile: "simplified-chinese-radicals.json",
    unitStart: 1,
    unitEnd: 201
  }
}, {
...
const vietnamese123LessonDefinitions = [
  [1, "I", "Tên tôi là Peter"],
  [2, "II", "Tôi là giáo viên"],
  [3, "III", "Anh bao nhiêu tuổi?"],
  [4, "IV", "Nhà của anh rất đẹp!"],
  [5, "V", "Cái này bao nhiêu tiền?"],
  [6, "VI", "Bây giờ là mấy giờ?"],
  [7, "VII", "Hôm nay là ngày bao nhiêu?"],
  [8, "VIII", "Anh đã có nhà riêng chưa?"],
  [9, "IX", "Khi rỗi, chị thường làm gì?"],
  [10, "X", "Anh đi thẳng đường này"]
] as const;

const vietnamese123LessonTargets: readonly ContentPackageGeneratorTarget[] = vietnamese123LessonDefinitions.map(([lesson, numeral, title]) => ({
  id: `vietnamese-custom-123-lesson-${String(lesson).padStart(2, "0")}`,
  explicitOnly: true,
  packageId: `local.user.decks.vietnamese-123.lesson-${String(lesson).padStart(2, "0")}`,
  displayName: `123Vietnamese Lesson ${numeral} - ${title}`,
  description: `Private bidirectional Vietnamese sentence and vocabulary deck for 123Vietnamese Lesson ${numeral}: ${title}.`,
  contentType: "topic-review",
  capabilities: ["topic-review"],
  deckFamily: "custom",
  relatedPackageIds: ["com.sleepymario.language.vietnamese"],
  ...
  notesPolicy: "omit",
  packageVersion: "0.1.0",
  sourcePath: `vietnamese-123/lesson-${String(lesson).padStart(2, "0")}`,
  sourceRepository: "local-only:whacksmacker-decks-private",
  languages: ["en", "vi"],
  targetLanguage: "vi",
  subjects: ["vietnamese", "custom", "123vietnamese", `lesson-${lesson}`],
  dependencies: [],
  include: ["README.md", "cards.tsv"],
  topic: {
    id: "123vietnamese",
    displayName: "123Vietnamese",
    deckDisplayName: `Lesson ${numeral} - ${title}`
  },
  topicDeck: {
    id: `vietnamese-123-lesson-${String(lesson).padStart(2, "0")}`,
    displayName: `Lesson ${numeral} - ${title}`,
    outputFile: `lesson-${String(lesson).padStart(2, "0")}.json`,
    unitStart: lesson,
    unitEnd: lesson
  }
}));
...
const rawContentPackageGeneratorTargets: readonly ContentPackageGeneratorTarget[] = [
  {
    ...
    displayName: "tmp",
    description: "Medical ABC sample with shared contextual artwork.",
    contentType: "topic-review",
    capabilities: ["topic-review"],
    deckFamily: "specialized",
    relatedPackageIds: ["com.sleepymario.language.chinese-traditional"],
    ...
    artifactRevision: 1,
    mediaPolicy: "required",
    interactionProfile: { ...defaultDeckInteractionProfile, outputMedia: "output-specific" },
    notesPolicy: "omit",
    packageVersion: "0.1.0",
    sourcePath: "chinese-traditional-specialized/medical-tmp",
    sourceRepository: "local-only:whacksmacker-decks-private",
    languages: ["en", "zh-Hant"],
    targetLanguage: "zh-Hant",
    subjects: ["medical", "specialized", "sample"],
    dependencies: [],
    include: ["README.md", "cards.tsv"],
    topicDeck: { id: "chinese-traditional-specialized-medical-tmp", displayName: "tmp", outputFile: "medical-tmp.json", unitStart: 1, unitEnd: 1 }
  },
  {
    id: "chinese-traditional-specialized-economics-tmp",
    explicitOnly: true,
    packageId: "com.sleepymario.language.chinese-traditional.specialized.economics-tmp",
    displayName: "economics - tmp",
    description: "Temporary insurance and economics vocabulary extracted from Medical I.",
    contentType: "topic-review",
    capabilities: ["topic-review"],
    deckFamily: "specialized",
    relatedPackageIds: ["com.sleepymario.language.chinese-traditional"],
    ...
    notesPolicy: "omit",
    packageVersion: "0.1.0",
    sourcePath: "chinese-traditional-specialized/economics-tmp",
    sourceRepository: "local-only:whacksmacker-decks-private",
    languages: ["en", "zh-Hant"],
    targetLanguage: "zh-Hant",
    subjects: ["economics", "insurance", "specialized"],
    dependencies: [],
    include: ["README.md", "cards.tsv"],
    topicDeck: { id: "chinese-traditional-specialized-economics-tmp", displayName: "economics - tmp", outputFile: "economics-tmp.json", unitStart: 1, unitEnd: 1 }
  },
  {
    id: "vietnamese-general-colours-vocabulary",
    explicitOnly: true,
    packageId: "com.sleepymario.language.vietnamese.general.colours-vocabulary",
    displayName: "Colours - Vocabulary",
    description: "Non-colour vocabulary from the Colours I example sentences, in both directions.",
    contentType: "topic-review",
    capabilities: ["topic-review"],
    deckFamily: "general",
    relatedPackageIds: ["com.sleepymario.language.vietnamese"],
    ...
    notesPolicy: "omit",
    packageVersion: "0.1.0",
    sourcePath: "vietnamese-general/colours-vocabulary",
    sourceRepository: "local-only:whacksmacker-decks-private",
    languages: ["en", "vi"],
    targetLanguage: "vi",
    subjects: ["vietnamese", "general", "colours-vocabulary"],
    dependencies: [],
    include: ["README.md", "cards.tsv"],
    topicDeck: { id: "vietnamese-general-colours-vocabulary", displayName: "Colours - Vocabulary", outputFile: "colours-vocabulary.json", unitStart: 1, unitEnd: 1 }
  },
  {
    id: "vietnamese-general-colours-i",
    explicitOnly: true,
    packageId: "com.sleepymario.language.vietnamese.general.colours-i",
    displayName: "Colours I",
    description: "Thirty everyday colours and shades, with English–Vietnamese bidirectional cards and simple Vietnamese examples.",
    contentType: "topic-review",
    capabilities: ["topic-review"],
    deckFamily: "general",
    relatedPackageIds: ["com.sleepymario.language.vietnamese"],
    ...
    notesPolicy: "omit",
    packageVersion: "0.1.0",
    sourcePath: "vietnamese-general/colours-i",
    sourceRepository: "local-only:whacksmacker-decks-private",
    languages: ["en", "vi"],
    targetLanguage: "vi",
    subjects: ["vietnamese", "general", "colours"],
    dependencies: [],
    include: ["README.md", "cards.tsv"],
